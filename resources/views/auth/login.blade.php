        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            <div class="login-brand">
              <img src="../assets/img/double-six-logo-black.png" alt="logo" width="200" class="shadow-light">
            </div>
            ...
            <div class="simple-footer">
              Copyright &copy; 2023 PT. Sixty Six Paradise Investasi.
            </div>
          </div>
        </div>
      </div>
